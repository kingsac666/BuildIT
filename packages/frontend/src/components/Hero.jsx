...
const Hero = () => {
  ...
  return (
    <div>
      <header className="py-4 bg-black sm:py-6 animate-fade-in">
        ...
        <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
          <div className="relative lg:flex lg:items-start lg:justify-between">
            <div className="lg:w-2/3">
              <p className="text-sm font-normal tracking-widest text-gray-300 uppercase mt-14 animate-fade-up animate-delay-100">A Hub for Designers, Developers &amp; Marketers</p>
              <h1 className="mt-6 text-4xl font-normal text-white sm:mt-10 sm:text-5xl lg:text-6xl xl:text-8xl animate-fade-up animate-delay-200">
              ...
              <p className="max-w-lg mt-4 text-xl font-normal text-gray-400 sm:mt-8 animate-fade-up animate-delay-300">
              ...
              <div className="relative inline-flex items-center justify-center mt-8 sm:mt-12 group animate-fade-up animate-delay-400">
              ...
              <div>
                <div className="inline-flex items-center pt-6 mt-8 border-t border-gray-800 sm:pt-10 sm:mt-14 animate-fade-up animate-delay-500">
            ...
            <div className="mt-8 md:absolute md:mt-0 md:top-32 lg:top-0 md:right-0">
              <img className="w-full max-w-xs mx-auto lg:max-w-lg xl:max-w-xl animate-fade-in-float" src="https://landingfoliocom.imgix.net/store/collection/dusk/images/hero/1/3d-illustration.png" alt="" />
            </div>
          </div>
        </div>
      </section>
